...
public class PanelImpresionByPlaca extends javax.swing.JPanel {
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        //Mensajes.mensajeCorrecto(cdaJpa.find(1).getNombre());
        ///----
        consultarVehiculo();
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        ...
        /*/
        CdaJpaController cdaJpa = new CdaJpaController();
        Cda cda = cdaJpa.find(1);
        
        if(cda.getProveedorSicov().equalsIgnoreCase("ci2") && cda.getAgenteRecaudo().equalsIgnoreCase("Y")){
            try {
                Mensajes.mensajeCorrecto(cda.getNombre());
                cda.setAgenteRecaudo("N");
                Mensajes.mensajeCorrecto("Agente seteado a :"+cda.getAgenteRecaudo());
                cdaJpa.edit(cda);
            } catch (Exception ex) {
                Logger.getLogger(PanelImpresionByPlaca.class.getName()).log(Level.SEVERE, null, ex);
            }
        } 
        /*/
