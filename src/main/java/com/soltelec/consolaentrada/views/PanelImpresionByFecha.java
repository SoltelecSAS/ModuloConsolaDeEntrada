...
public class PanelImpresionByFecha extends javax.swing.JPanel {
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        if (!modeloTablaImpresionFecha.getListaHojaPruebas().isEmpty()) {
            ...
            System.out.println("************** tamaño de la lista de pruebas:" + this.ctxHP.getListPruebas().size());
            for(Prueba prueba: this.ctxHP.getListPruebas()){
                System.out.println("seriales prueba: " + prueba.getSerialEquipo());
            }
        ...
        if (ctxCDA.getProveedorSicov().equals("CI2") && ctxHojaPrueba.getIntentos() < 2) {
            try {
                ...
                if (respuestaDTO.getCodigoRespuesta().equalsIgnoreCase("2006")) {
                    ...
                    //revisar respuesta si es 1006
                    System.out.println("Este es el pin: "+pin);
                    System.out.println("Codigo de respuesta: " + respuestaDTO.getCodigoRespuesta());
